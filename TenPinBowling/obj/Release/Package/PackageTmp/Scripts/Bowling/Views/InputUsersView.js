    ...
    function ($, Backbone,
        ...
        var InputUsersView = Backbone.View.extend({
            ...
            initialize: function () {
                ...
                this.bowlingUserCollection = new BowlingUserCollection();
                this.bowlingUserCollection.on("reset", this.navigateToBowlingCard, this);
            ...
            navigateToBowlingCard: function() {
            ...
            createScoreCard: function () {
                ...
                view.$("#userNames").find("input.user-name").each(function(index, obj) {
                    view.bowlingUserCollection.add({
                        UserId: index+1,
                        UserName: obj.value
                    });
                });

                view.bowlingUserCollection.save();             
            },
